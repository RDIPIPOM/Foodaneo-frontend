<template>
  <div>
    ...
    <div class="nav-menu-categories">
      ...
      <a href="./#/lunches" class="nav-menu-category nav-menu-category-active"><img class="img-menu-category" src="../assets/img/lunch-active-icon.svg" alt=""></a>
