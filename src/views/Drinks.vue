<template>
  <div>
    ...
    <div class="nav-menu-categories">
      <a href="./#/breakfasts" class="nav-menu-category"><img class="img-menu-category" src="../assets/img/breakfast-icon.svg" alt=""></a>
      <a href="./#/lunches" class="nav-menu-category"><img class="img-menu-category" src="../assets/img/lunch-icon.svg" alt=""></a>
      <a href="./#/drinks" class="nav-menu-category nav-menu-category-active"><img class="img-menu-category" src="../assets/img/drink-active-icon.svg" alt=""></a>
    ...
    <div class="body category-subtitle">Para quitar la sed y acompañar tu comida</div>
